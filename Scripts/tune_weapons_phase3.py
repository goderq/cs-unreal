...
recoil pattern and how fast a series recovers.
...
TUNING = {
    ...
    "M4":            (4.0,  8.0,  8, 0.45),
    "SMG":           (2.0,  5.0, 12, 0.40),
    "Shotgun":       (1.5,  4.0,  1, 0.60),
    "Sniper":        (12.0, 20.0, 1, 1.00),
    "StarterPistol": (1.6,  5.0,  5, 0.35),
}

lines = []
for key, (move, jump, shots, recovery) in TUNING.items():
    ...
    lines.append("%s: move %.1f, jump %.1f, pattern %d, recovery %.2f" % (key, move, jump, shots, recovery))
