...
> **Статус: v1.1.0 — режимы (Deathmatch, Team Deathmatch, 5 на 5), магазин и валюта, две новые карты, гранаты, реальные звуки оружия, новый интерфейс. Проверено двумя клиентами.**
