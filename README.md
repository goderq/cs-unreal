...
> **Статус: Этап 1 — код написан, но ещё ни разу не компилировался.**
> На этой машине нет MSVC. Пока не поставлен Visual Studio, проект собрать
> нельзя. См. [docs/PHOTON_SETUP.md](docs/PHOTON_SETUP.md#установка-компилятора).
...
- Интеграция Photon Fusion 3 с **автодетектом SDK** — проект собирается и без
  установленного плагина (offline-режим)
