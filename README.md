...
> **Статус: Этап 1.** Fusion Unreal SDK 3.0.0-Preview-1498 установлен, весь
> код сверен с его реальными заголовками. Тулчейн (MSVC 14.44 + Windows SDK
> 10.0.26100) поставлен, идёт первая сборка.
